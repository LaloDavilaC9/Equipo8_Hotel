 ...
 * @author victo
 */
public class PersonasHospedadas extends javax.swing.JFrame {

    /**
     * Creates new form ConsultarPorNombre
     */
    public PersonasHospedadas() {
        initComponents();
        ...
        while (it.hasNext()) {
            ...
            this.jTextAreaInformacion.append("Nombre: "+e.getKey() + "\nHabitacion: " + e.getValue()+"\n\n");
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Personas hospedadas actualmente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PersonasHospedadas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PersonasHospedadas().setVisible(true);
            }
        });
    }
